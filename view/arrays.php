...
$nomes3 = array(
    'Atum', 'Roamana', 'Jardineira'
);

$nomes4 = array(
    'Aliche','Atum Especial','Peruana'
);

$nomes5 = array(
    'Calabresa','Baiana Especial','Concheta','Calabresa Especial','Paulista'
);

$nomes6 = array(
    'Baiana','Baiacatu','Pizzaiolo','Toscana',''
);
...
$nomes8 = array(
    'Nobre','Portuguesa Especial'
);

$nomes9 = array(
    'Frango com Catupiry', 'Caipira','Baronesa'
);

$nomes10 = array(
    'Frango com Catupiry Legítimo', 'À moda','Veneza'
);
...
$nomes13 = array(
    'Catupiry Legítimo','Napolitana','2 Queijos','4 Queijos'
);

$nomes14 = array(
    'Marguerita','Mussarela','3 Queijos',''
);

$nomes15 = array(
    'Abobrinha','Escarola','Escarola Especial','Palmito','Vegetariana','Brócolis'
);

$nomes16 = array(
    'Alho','Escarola À Manja','Champignon','Milho Verde','Vegetariana Especial',''
);
...
$ing = array(
    'Molho de tomate, mussarela, bacon e ovos',
    'Molho de tomate, bacon, catupiry e parmesão',
    'Molho de tomate, presunto, bacon, champignon e catupiry'
);
...
$ing6 = array(
    'Molho de tomate, calabresa moída, ovos, cebola e pimenta',
    'Molho de tomate, calabresa moída, bacon, e ctupiry ou cheddar',
    'Molho de tomate, presunto calabresa, champignon, bacon e mussarela',
    'Molho de tomate, mussarela, calabresa moída e parmesão',''
);

$ing7 = array(
    'Molho de tomate, presunto, palmito, milho e catupiry',
    'Molho de tomate, presunto, tomate em rodelas, mussarela e parmesão'
);

$ing8 = array(
    'Molho de tomate, presunto, frango e mussarela',
    'Molho de tomate, presunto, ovos, ervilha, palmito e mussarela'
);
...
$ing11 = array(
    'Molho de tomate, lombinho, cebola e parmesão',
    'Molho de tomate, lombinho, bacon e mussarela'
);
...
$ing14 = array(
    'Molho de tomate, mussarela, tomate em fatias e manjericão',
    'Molho de tomate, mussraela e orégano',
    'Molho de tomate, mussarela, catupiry e parmesão <br> (opção com Cream Cheese)',
    ''
);
...
$ing15 = array(
    ...
    'Molho de tomate, ervilha, palmito, milho, tomate em fatias e mussarela',
    'Molho de tomate, brócolis refogado, catupiry e bacon'
);
